...
RSpec.describe Bucket, type: :model do
  subject { create(:bucket, created_by: 1) }
  ...
  describe "Names scopes" do
    it "paginates bucket results" do
      create_list(:bucket, 20, created_by: 1)
      pager = {
        limit: 14,
        offset: 0
      }
    ...
    it "searches for matching buckets" do
      ...
      search_bucket = create(:bucket, name: datum, created_by: 1)
      create_list(:bucket, 5, created_by: 1)
